...
// publically exported for use by `srml/support/src/origin.rs`
pub use sr_primitives::traits::{DoughnutApi};
...
use srml_support::{
	...
	additional_traits::{DispatchVerifier as DispatchVerifierT, MaybeDoughnutRef},
};
